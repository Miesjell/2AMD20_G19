...
class FoodKnowledgeGraph:
    ...
    def load_data(self, data_dir: str, 
                  sample_recipes: int = 1000,
                  sample_persons: int = 1000) -> Dict[str, Any]:
        """
...
def parse_args():
    ...
    parser.add_argument("--sample-recipes", type=int, default=1000,
                        help="Number of recipes to sample")
    parser.add_argument("--sample-persons", type=int, default=1000,
...
def main():
    ...
    try:
        ...
        if not args.skip_relationships:
            ...
            logger.info(f"Relationship creation results: {json.dumps(rel_results, indent=2)}")
